...
Page({
  ...
  saveApplicant() {
    ...
    console.log(indexMaritalStatus)
    ...
    wx.navigateTo({
      url: '/pages/fumin/applicantUpload/applicantUpload?applicantType=' + this.data.type + "&maritalStatus=" + this.data.applicant.maritalStatus
    })
  }
})