...
export default {
  ...
  data() {
    return {
      ...
      attributes: [],
      rules: {
        sex: [{ required: true, message: '此字段不能为空', trigger: 'blur' }],
        name: [{ required: true, message: '此字段不能为空', trigger: 'blur' }],
        maritalStatus: [{ required: true, message: '此字段不能为空', trigger: 'change' }],
        idCardNumber: [{ required: true, message: '此字段不能为空', trigger: 'blur' }],
        phoneNumber: [{ required: true, message: '此字段不能为空', trigger: 'blur' }],
        spouseIdCardNumber: [{ required: true, message: '此字段不能为空', trigger: 'blur' }],
        spouseName: [{ required: true, message: '此字段不能为空', trigger: 'blur' }],
        applicantType: [{ required: true, message: '此字段不能为空', trigger: 'change' }],
        applicantAmount: [{ required: true, message: '此字段不能为空', trigger: 'blur' }],
        applicantCategory: [{ required: true, message: '此字段不能为空', trigger: 'change' }],
        recruitCategory: [{ required: true, message: '此字段不能为空', trigger: 'change' }],
        address: [{ required: true, message: '此字段不能为空', trigger: 'blur' }]
      },
      rensheRulrs: {
