...
CREATE TABLE `litemall_applicant`  (
 `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  ...
  `asset_url` varchar(255) NULL DEFAULT NULL COMMENT '个人资产证明',
  `job_url` varchar(255) NULL DEFAULT NULL COMMENT '就业创业证1',
  `job_url_2` varchar(255) NULL DEFAULT NULL COMMENT '就业创业证2',
  `mortgage_url` varchar(255) NULL DEFAULT NULL COMMENT '抵押信息',
  `guarantee_statement_url` varchar(255) NULL DEFAULT NULL COMMENT '共同担保声明',
  ...
  `sc_operator` varchar(20) NULL DEFAULT NULL COMMENT '担保公司经办人',
  `sc_extra_pic_url` varchar(255) NULL DEFAULT NULL COMMENT '担保公司补充图片',
  `b_bank_id` int(20) NULL DEFAULT NULL COMMENT '受理银行ID',
  `b_name` varchar(20) NULL DEFAULT NULL COMMENT '受理银行',
  `b_sub_branch` varchar(20) NULL DEFAULT NULL COMMENT '支行',
  `b_opertator` varchar(20) NULL DEFAULT NULL COMMENT '经办人',
  `b_credit` varchar(20) NULL DEFAULT NULL COMMENT '授信额度',
  `b_lending_date` datetime(0) NULL DEFAULT NULL COMMENT '放贷日期',
  `b_period_loan` varchar(20) NULL DEFAULT NULL COMMENT '贷款期限',
